...
INSERT INTO course VALUES
	...
	(23, 'IT Project Management', "Master the art of managing information technology projects. Learn project planning, scope definition, resource allocation, and risk management. Explore agile and traditional project management methodologies. Understand the role of project managers in overseeing successful IT initiatives, ensuring projects are delivered on time, within scope, and aligned with business goals.", 1, 1),
	(24, 'Marketing Management', "Explore the principles of marketing, including market research, consumer behavior, branding, and marketing strategies. Learn to create effective marketing campaigns and develop skills to analyze market trends and customer preferences.", 3, 1),
	(25, 'Microeconomics', "Study the behavior of individual economic agents, such as consumers, firms, and markets. Explore concepts like supply and demand, elasticity, consumer choice, and market structures.", 2, 1),
	(26, 'Introduction to Sociology', "Explore the fundamental concepts of society, culture, and human behavior. Study social institutions, socialization, inequality, and the impact of social change on individuals and communities", 4, 1),
	(27, 'Constitutional Law', "Study the constitution and its impact on government and individual rights. Explore topics such as separation of powers, federalism, and constitutional interpretation.", 5, 1),
	(28, 'Cost Accounting', "Focus on understanding and analyzing costs in business operations. Learn techniques for cost allocation, cost-volume-profit analysis, and cost estimation.", 6, 1),
	(29, 'Ethics in Accounting', "Examine ethical considerations in the field of accounting. Learn about professional ethics, conflicts of interest, confidentiality, and the role of accountants in maintaining integrity.", 6, 1),
