<template>
  <div>
    ...
    <button @click=runCourseAction(course.course_ID) class="btn btn-blue-green hop-on text-light font-weight-bold text-nowrap" v-if="status == 'Active'" title="Register">Hop On</button>
    ...
    <button @click=runCourseAction(course.rcourse_ID) class="btn btn-danger delete-run-course text-light font-weight-bold text-nowrap" v-else-if="status == 'delete-run-course'" title="Delete Run Course">Delete</button>
  </div>
</template>
