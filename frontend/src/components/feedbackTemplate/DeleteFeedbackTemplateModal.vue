      ...
      <div class="modal-body pt-1"> 
        ...
        <div v-if="!error">
          ...
          <div class="col-6 offset-6 d-flex justify-content-between">
            <button type="button" :disabled="disabled" :title="disabled ? 'Unable to delete feedback template due to ongoing/past feedback period' : ''" class="mt-4 btn delete btn-danger float-right w-100" id="delete-feedback-template"  @click="deleteTemplate">Delete</button>
