...
export default {
  ...
  computed: {
    showNavBar() {
      ...
      const routesWithNavBar = ["ContactUs", "viewCourse","adminViewRunCourse", "adminViewVoteCourse", "adminViewProposedCourse","adminVotingCampaign", "adminViewInstructorsTrainers", "studentViewCourse","studentViewProfile", "editProposedCourse", "instructorTrainerViewProfile","proposeCourse", "editCourse", "createCourse", "createRunCourse", "editRunCourse", "instructorTrainerViewVotingCampaign", "adminViewCourse", "studentViewRecommendations", "adminViewManagement", "adminViewStudentEnrolledCourse", "adminAddAdmin", "adminViewCourseRun", "createFeedbackTemplate", "editFeedbackTemplate" ,"adminViewFeedbackTemplate", "submitFeedback", "viewAllLessons", "viewRunCourseLesson", "viewRunCourseLesson"];
